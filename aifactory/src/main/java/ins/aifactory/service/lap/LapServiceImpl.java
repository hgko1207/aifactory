...
public class LapServiceImpl extends InsBaseServiceImpl<Lap, LapCriterion> implements LapService {
	...
	@Autowired
	LapAdhrncService lapAdhrncService;
	...
	/*
	 * Lap의 종료 처리 1. 활성상태(ACTVTY_YN = 'Y')인 랩 2. END_DTTM의 값이 있을 경우 END_DTTM의 값이
	 * CURRENT_DATE보다 작거나 같은 랩 3. 체크 타임에 GOAL_SCRE이상인 참가자가 있는 랩
	 */
	@Override
