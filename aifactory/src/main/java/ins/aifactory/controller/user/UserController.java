...
public class UserController extends AbstractController {
	...
	public String updateForm(HttpServletRequest request, HttpServletResponse response, ModelMap modelMap, User entity,
	...
	public String update(HttpServletRequest request, HttpServletResponse response, ModelMap modelMap,
			@ModelAttribute User entity, BindingResult result, SessionStatus status, Authentication authentication) {
		validator.validate(entity, result);
		if (result.hasErrors())
			throw new ParameterValidException(result);
		else {
	...
	public String chkPwd(HttpServletRequest request, HttpServletResponse response, ModelMap modelMap,
			@RequestParam(required = true) String pwd, Authentication authentication) {
		LoginInfo principal = new LoginInfo();
		if (authentication != null)
			principal = (LoginInfo) authentication.getPrincipal();
	...
	public boolean chkPwdModifyValid(@RequestParam(required = true, value = "oldUserPwd") String userPwd,
