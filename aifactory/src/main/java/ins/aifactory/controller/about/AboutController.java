...
public class AboutController extends AbstractController {
	...
	public String search(HttpServletRequest request, HttpServletResponse response, ModelMap modelMap,
			PostCriterion criterion, BindingResult result, SessionStatus status, Authentication authentication) {
	...
	public String searchAjax(HttpServletRequest request, HttpServletResponse response, ModelMap modelMap,
			PostCriterion criterion, BindingResult result, SessionStatus status, Authentication authentication) {
		LoginInfo principal = new LoginInfo();
		if (authentication != null)
			principal = (LoginInfo) authentication.getPrincipal();
	...
	public String insert(HttpServletRequest request, HttpServletResponse response, ModelMap modelMap,
			@ModelAttribute Post entity, BindingResult result, SessionStatus status) {
	...
	public String detail(HttpServletRequest request, HttpServletResponse response, ModelMap modelMap, Post entity,
	...
	public String updateForm(HttpServletRequest request, HttpServletResponse response, ModelMap modelMap, Post entity,
			BindingResult result) {
