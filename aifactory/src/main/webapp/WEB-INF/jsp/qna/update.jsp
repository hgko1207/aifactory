...
$( document ).ready(function() {
    ...
    editor.setHtml(unescape('${qna.qnaCn}'));
                ...
                <div class="card-body row ml-3">
                    <div class="d-inline-flex" style="width: 98%">
                        ...
                        <div class="form-group col-10 form-group-feedback input-group">
                            <input id="qnaSj" name="qnaSj" value="${qna.qnaSj}" type="text" class="form-control" required="required" />
                        </div>
                    </div>
                    <div class="d-inline-flex" style="width: 98%">
                        <div class="col-2">
