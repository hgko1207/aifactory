...
$( document ).ready(function() {
    ...
    editor.setHtml(unescape('${recruitPost.postDc}'));
    
    
   
    // 수정
    $('#btnRecruitPostUpdate').click(function(){
    ...
    <c:choose>
        <c:when test="${!empty recruitPost.cmmnFile && !empty recruitPost.cmmnFile.files}">
            $('#previewArea').show();
        </c:when>
        <c:otherwise>
            $('#imageFileArea').show();
...
function submitForm(){
    ...
    $.ajax_form({
        url:'<c:url value="/about/recruitPostUpdate.do" />',
        formId:'recruitPost',
        otherParam:param,
                            ...
                            <div id="basic-content" class="markdown-converter__text--rendered">
                                <div class="card-body row ml-3">
                                    ...
                                    <div class="col-lg-11 text-right">
                                        <button type="button" id="btnRecruitPostUpdate" class="btn btn-primary">
