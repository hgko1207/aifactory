...
function submitForm(){
   // var param = lapObjs.toParam();
    ...
    $.ajax_form({
        url:contextName()+'/community/insert.do',
        formId:'post',
        otherParam:param,
        success: function (data) {
            alert('저장 되었습니다.');
            location.href = contextName()+'/community/detail.do?postId='+data.post.postId;
        }
    });
}
...
<div class="card overview">
    <div class="card-header bg-white header-elements-inline">
        <h5 class="card-title">
            <i class="icon-cube3 mr-2"></i>${post.postCt} Posting 
        </h5>
    </div>
    <div class="card-body">
        <div class="d-md-flex">
            <div class="container">
                ...
                <div class="tab-content">
                    <form:form commandName="post" method="POST" cssClass="form-validate">
                        <form:input path="postCt" type="hidden" value="${post.postCt}"/>
